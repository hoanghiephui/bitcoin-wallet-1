    ...
    private void maybeShowInactivityNotification(final WalletApplication application) {
        ...
        if (!canDonate) {
            ...
            notification.addAction(new NotificationCompat.Action.Builder(0,
                    ...
                    PendingIntent.getBroadcast(application, 0, dismissIntent, FLAG_IMMUTABLE)).build());
        }
        ...
        notification.addAction(new NotificationCompat.Action.Builder(0,
                ...
                PendingIntent.getBroadcast(application, 0, dismissForeverIntent, FLAG_IMMUTABLE)).build());
        ...
        if (canDonate) {
            ...
            notification.addAction(new NotificationCompat.Action.Builder(0,
                    ...
                    donateIntent, FLAG_IMMUTABLE)).build());
        }
